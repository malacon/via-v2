...
export default {
	...
	theme: {
		...
		extend: {
			backgroundImage: {
				'fade-both':
					'linear-gradient(to left, rgba(0,0,0,0) 0%, rgba(0,0,0,0.5) 50%, rgba(0,0,0,0) 100%)',
				'fade-right':
					'linear-gradient(to left, rgba(0,0,0,.5) 0%, rgba(0,0,0,1) 100%)',
				'fade-left':
